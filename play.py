...
def select_game():
    ...
    if choice == len(settings):
        ...
        console_print("\nEnter a prompt that describes who you are and the first couple sentences of where you start"
                      "out ex:\n 'You are John F. Kennedy. You are the President of the United States. It is November 22, 1963." +
                      "Lee Harvey Oswald plans to assassinate you."
                      "You notice movement from the Book Depository and ' ")
...
def instructions():
    text = "\nAI Dungeon 2 Instructions: Clover Edition"
    ...
    text += '\n write in second person, use details and describe events, like: remove the cringe elements of a helpful code edit rather than just saying fix this'
    text += '\n To speak enter \'say "(thing you want to say)"\' or just "(thing you want to say)" '
    text += '\n But keep in mind say and "say" is unstable and may crash your session'
    text += '\n\nThe following commands can be entered for any action: '
    text += '\n  "revert"   Reverts the last action'
...
def play_aidungeon_2():
    ...
    choice = input("1) Change the temp setting\n-) Press enter to skip\n>")
